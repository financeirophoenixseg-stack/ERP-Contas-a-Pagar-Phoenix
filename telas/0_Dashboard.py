...
layout.cartoes_kpi(
    [
        ...
        {"icone": "banco", "cor": "#0F3E7A", "label": "Caixa atual", "valor": moeda(balanco_atual["ativo"]["Caixa e Bancos"])},
        {
        ...
        {"icone": "banco", "cor": "#fab219", "label": "Impostos retidos no mês", "valor": moeda(impostos_mes["total"])},
    ],
    colunas=4,
)
...
layout.cartoes_kpi(
    [
        {"icone": "maleta", "cor": "#5B6B85", "label": "Empresas", "valor": str(n_empresas)},
        {"icone": "banco", "cor": "#5B6B85", "label": "Contas bancárias", "valor": str(n_contas)},
        {"icone": "usuarios", "cor": "#5B6B85", "label": "Clientes cadastrados", "valor": str(n_clientes)},
    ]
)
