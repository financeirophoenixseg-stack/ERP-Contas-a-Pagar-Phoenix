...
- ⚠️ Pendente do usuário: nenhum parser para outra seguradora (ex.: Bradesco) foi construído ainda porque não há um PDF real para validar contra — mesmo critério usado até aqui (só construir e confiar num parser depois de ver o documento real).
