...
- **Semana 6 — status:** segurança ✅, backup ✅, anexos + SharePoint ✅. Restam: mais testes com arquivos reais (depende do usuário enviar mais demonstrativos) e preparação final para uso.
