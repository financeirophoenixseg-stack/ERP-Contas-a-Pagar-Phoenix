...
- ⚠️ Pendente do usuário: fazer a primeira importação real desse demonstrativo Bradesco Saúde pela tela `Importar Comissão`, informando o nome do cliente da apólice 1117397/1 (não inventei esse nome — só quem sabe é o usuário).
