...
- **Semana 6 — status:** segurança ✅, backup ✅, anexos + SharePoint ✅, leitura de boleto por IA ✅ (validada contra arquivo real), baixa automática por comprovante ✅, revisão de ponta a ponta ✅, datas/valores em formato brasileiro ✅. Restam: mais testes com arquivos reais (depende do usuário enviar mais demonstrativos) e preparação final para uso.
